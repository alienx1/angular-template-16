...
declare module '@angular/common/http/index' {
  ...
  export interface HttpClient {
    ...
    /**
     * Do not use Jwt bearer for this request.
     * @return {HttpClient} The new instance.
     */
    skipJwtHandler(): HttpClient;
    /**
    * Do not use data Cconvert for this request.
    * @return {HttpClient} The new instance.
    */
    skipDataConvert(): HttpClient;
  }
...
export class HttpService extends HttpClient {
  ...
  override request(method?: any, url?: any, options?: any): any {
    let handler = this.httpHandler;
    // if (url && !url.startsWith(environment.authUrl)) {
      handler = this.interceptors.reduceRight(
